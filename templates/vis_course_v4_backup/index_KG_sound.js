...
let nodes1 = [
    ...
    { "id": 6, "name": "d", "group": 3 },
    { "id": 7, "name": "人", "group": 1 },
    { "id": 10, "name": "日", "group": 1 },
    { "id": 11, "name": "e", "group": 2 },
    { "id": 13, "name": "土", "group": 1 },
    { "id": 14, "name": "ai", "group": 2 },
    { "id": 16, "name": "木", "group": 1 },
    { "id": 17, "name": "u", "group": 2 },
    { "id": 18, "name": "b", "group": 3 },
    { "id": 19, "name": "又", "group": 1 },
    { "id": 20, "name": "an", "group": 2 },
    { "id": 21, "name": "f", "group": 3 },
    { "id": 22, "name": "辶", "group": 1 },
    { "id": 25, "name": "不", "group": 1 },
    { "id": 28, "name": "女", "group": 1 },
    { "id": 30, "name": "m", "group": 3 }
];

let tempEdges1 = [
    { "id": 1, "source": 2, "target": 1, "relation": "韵母", "value": 3 },
    { "id": 2, "source": 3, "target": 1, "relation": "声母", "value": 3 },
    { "id": 3, "source": 2, "target": 4, "relation": "韵母", "value": 2 },
    { "id": 4, "source": 6, "target": 4, "relation": "声母", "value": 3 },
    { "id": 5, "source": 2, "target": 7, "relation": "韵母", "value": 3 },
    { "id": 6, "source": 3, "target": 7, "relation": "声母", "value": 3 },
    { "id": 7, "source": 11, "target": 10, "relation": "韵母", "value": 3 },
    { "id": 8, "source": 6, "target": 10, "relation": "声母", "value": 2 },
    { "id": 9, "source": 14, "target": 13, "relation": "韵母", "value": 2 },
    { "id": 10, "source": 6, "target": 13, "relation": "声母", "value": 3 },
    { "id": 11, "source": 17, "target": 16, "relation": "韵母", "value": 2 },
    { "id": 12, "source": 18, "target": 16, "relation": "声母", "value": 1 },
    { "id": 13, "source": 20, "target": 19, "relation": "韵母", "value": 3 },
    { "id": 14, "source": 21, "target": 19, "relation": "声母", "value": 2 },
    { "id": 15, "source": 14, "target": 22, "relation": "韵母", "value": 1 },
    { "id": 16, "source": 18, "target": 22, "relation": "声母", "value": 1 },
    { "id": 17, "source": 17, "target": 25, "relation": "韵母", "value": 3 },
    { "id": 18, "source": 18, "target": 25, "relation": "声母", "value": 2 },
    { "id": 19, "source": 2, "target": 28, "relation": "韵母", "value": 1 },
    { "id": 20, "source": 30, "target": 28, "relation": "声母", "value": 2 }
];
...
let nodes3 = [
    ...
    { id: 8, name: '厶', group: 2 },
    { id: 9, name: '日', group: 4 },
    { id: 10, name: '亠', group: 2 },
    { id: 11, name: '十', group: 2 },
    { id: 12, name: '夂', group: 3 },
    { id: 13, name: '一', group: 1 },
    { id: 14, name: '人', group: 2 },
    { id: 15, name: '口', group: 3 },
...
// 边集
let tempEdges3 = [
    { id: 1, source: 13, target: 15, relation: '相关关系', value: 4 },
    { id: 2, source: 14, target: 13, relation: '相关关系', value: 4 },
    { id: 3, source: 14, target: 15, relation: '相关关系', value: 4 },
    { id: 4, source: 13, target: 8, relation: '相关关系', value: 3 },
    { id: 5, source: 10, target: 15, relation: '相关关系', value: 3 },
    { id: 6, source: 12, target: 15, relation: '相关关系', value: 3 },

    { id: 8, source: 13, target: 9, relation: '相关关系', value: 2 },

    { id: 11, source: 15, target: 2, relation: '相关关系', value: 2 },
    { id: 12, source: 15, target: 3, relation: '相关关系', value: 2 },
    { id: 13, source: 15, target: 9, relation: '相关关系', value: 2 },
    { id: 14, source: 15, target: 4, relation: '相关关系', value: 2 },
    { id: 15, source: 3, target: 10, relation: '相关关系', value: 2 },

    { id: 20, source: 7, target: 11, relation: '相关关系', value: 2 },
    // 其他边...
]
...
function createForceDirectedGraph(selector, options) {
    ...
    function getNodeColor(group) {
        const colors = ['#607460', '#7d1f33', '#ba794d', '#464e65'];
        return colors[group % colors.length]; // 使用模运算符确保 group 值在颜色数组的范围内
    }
    ...
    var nodeText = gs.append('text')
        ...
        .style('font-family', '行楷, 正楷体, 生肖体, STKaiti, FangSong, serif')      // 设置字体为行楷
        .attr('x', function ({ name }) {
            return textBreaking(d3.select(this), name);
        });
    gs.append('title')

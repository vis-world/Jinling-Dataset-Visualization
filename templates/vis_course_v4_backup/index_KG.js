...
let nodes1 = [
    ...
    { id: 11, name: '客', group: 1 },
    { id: 12, name: '夂', group: 2 },
    { id: 13, name: '唱', group: 1 },
    { id: 14, name: '日', group: 2 },
    { id: 15, name: '错', group: 1 }
];

// 边集
let tempEdges1 = [
    { id: 1, source: 2, target: 1, relation: '组成', value: 2 },
    { id: 2, source: 3, target: 1, relation: '组成', value: 2 },
    { id: 3, source: 5, target: 1, relation: '组成', value: 2 },
    { id: 4, source: 2, target: 4, relation: '组成', value: 2 },
    { id: 5, source: 3, target: 4, relation: '组成', value: 2 },
    { id: 6, source: 5, target: 4, relation: '组成', value: 2 },
    { id: 7, source: 5, target: 6, relation: '组成', value: 2 },
    { id: 8, source: 3, target: 6, relation: '组成', value: 2 },
    { id: 9, source: 3, target: 7, relation: '组成', value: 2 },
    { id: 10, source: 8, target: 7, relation: '组成', value: 2 },
    { id: 11, source: 10, target: 9, relation: '组成', value: 2 },
    { id: 12, source: 5, target: 9, relation: '组成', value: 2 },
    { id: 13, source: 12, target: 11, relation: '组成', value: 2 },
    { id: 14, source: 5, target: 11, relation: '组成', value: 2 },
    { id: 15, source: 5, target: 13, relation: '组成', value: 2 },
    { id: 16, source: 14, target: 13, relation: '组成', value: 2 },
    { id: 17, source: 3, target: 15, relation: '组成', value: 2 },
    { id: 18, source: 14, target: 15, relation: '组成', value: 2 }
];
